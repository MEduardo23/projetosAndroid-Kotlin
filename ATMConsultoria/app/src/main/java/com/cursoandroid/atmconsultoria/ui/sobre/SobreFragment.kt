...
class SobreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val descricao =
            "A ATM Consultoria tem como missão apoiar organizações que desejam alcançar o sucesso através da excelência em gestão e da busca pela qualidade."

        val versao = Element().apply {
            title = "Versão 1.0"
        }

        return AboutPage(requireActivity())
